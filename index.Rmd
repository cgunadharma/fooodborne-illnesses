...
This line graph is intended to show the relationship between days (in June of 2016) and average temperature variation in Seattle to show how temperature trends have changed.
...
This chart is a bar chart that compares cities the average temperatures in cities in Washington, Oregon and California on March 7th, 2015.




This chart conveys the temperatures in these cities on a given day.
